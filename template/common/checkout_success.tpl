					...
					<div class="column fixed" style="width:580px;">
						<div class="container" style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-weight: 300;color:#5e3e1a;font-size:12px;"> 
							...
							<div id="content">
							    ...
							    <h2>Pesanan Anda Telah Diproses</h2>
							  	Pesanan Anda telah berhasil diproses.<br /><br />

								Tunggu konfirmasi dari kami maksimal 1 x 24 jam. <br />
								Kami akan mengkonfirmasi ketersediaan pemesanan Anda melalui telepon atau sms.<br /><br />

								Terima kasih untuk berbelanja dengan kami.
							  <div class="buttons">
