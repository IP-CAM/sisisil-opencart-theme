				...
				<div class="columns" style="padding-bottom:13px;">
					...
					<div class="column fixed" style="width:784px;">
						<div class="container">
							...
							<?php } ?>
							<div id="content" style="width:777px;color:#666666;"><?php echo $content_top; ?>
								  ...
								  <table>
									...
									<tbody>
									  ...
									  <tr>
										...
										<td class="quantity"><input type="text" name="quantity[<?php echo $product['key']; ?>]" value="<?php echo $product['quantity']; ?>" size="1" style="width:50px;" />
										  &nbsp;
							  ...
							  <div class="buttons">
								<div class="right"><br /><a href="<?php echo $checkout; ?>" class="ss-checkout-button" style="display:block;"></a></div>
								<div class="center"><br /><a href="<?php echo $continue; ?>" class="ss-continue-shopping-button" style="display:block;margin-left:200px;"></a></div>
							  </div>
							</div>
						</div>
					</div>
