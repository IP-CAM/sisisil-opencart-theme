			...
			<div class="container"> 
				...
				<div class="columns" style="padding-bottom:13px;">
					...
					<div class="column fixed" style="width:580px;">
						<div class="container" style="font-family: 'HelveticaNeue-Light', 'Helvetica Neue Light', 'Helvetica Neue', Helvetica, Arial, 'Lucida Grande', sans-serif; font-weight: 300;color:#666666;font-size:12px;"> 
...
$('.checkout-heading a').live('click', function() {
	...
	$('#checkout .checkout-heading').removeAttr("style");
	$('#payment-address  .checkout-heading').removeAttr("style");
	$('#shipping-address  .checkout-heading').removeAttr("style");
	$('#shipping-method  .checkout-heading').removeAttr("style");
	$('#payment-method  .checkout-heading').removeAttr("style");
	$('#confirm  .checkout-heading').removeAttr("style");
	$(this).parent().parent().find('.checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
...
$(document).ready(function() {
	$.ajax({
		...
		success: function(html) {
			...
			$('#checkout .checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
...
$(document).ready(function() {
	$.ajax({
		...
		success: function(html) {
			...
			$('#payment-address .checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
		},
		error: function(xhr, ajaxOptions, thrownError) {
			alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
		}
			...
			if (json['redirect']) {
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$('#payment-method  .checkout-heading').removeAttr("style");
							$('#confirm  .checkout-heading').removeAttr("style");
							$('#shipping-method  .checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
						},
						error: function(xhr, ajaxOptions, thrownError) {
							alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
						}
					...
					$.ajax({
						...
						success: function(html) {
							...
							$('#payment-method  .checkout-heading').removeAttr("style");
							$('#confirm  .checkout-heading').removeAttr("style");
							$('#shipping-address  .checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
						},
						error: function(xhr, ajaxOptions, thrownError) {
							alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
						}
				...
				$.ajax({
					...
					success: function(html) {
						...
						$('#payment-method  .checkout-heading').removeAttr("style");
						$('#confirm  .checkout-heading').removeAttr("style");
						$('#payment-method  .checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
					},
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
					}
			...
			if (json['redirect']) {
				...
				$.ajax({
					...
					success: function(html) {
						...
						$('#payment-method  .checkout-heading').removeAttr("style");
						$('#confirm  .checkout-heading').removeAttr("style");
						$('#confirm  .checkout-heading').css({ "background":"#a6cfae", "color":"#ffffff"});
					},
					error: function(xhr, ajaxOptions, thrownError) {
						alert(thrownError + "\r\n" + xhr.statusText + "\r\n" + xhr.responseText);
					}
