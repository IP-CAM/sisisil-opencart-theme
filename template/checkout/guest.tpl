...
<div>
  <table class="form">
	<tr>
		...
		<td valign="top"><input type="text" name="firstname" value="<?php echo $firstname; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Nama Belakang <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="lastname" value="<?php echo $lastname; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Email <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="email" value="<?php echo $email; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Telepon <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="telephone" value="<?php echo $telephone; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top"><?php echo $entry_fax; ?></td>
	  <td valign="top"><input type="text" name="fax" value="<?php echo $fax; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
  </table>
</div>
...
<div>
  <table class="form">
	...
	<input type="text" name="company_id" value="<?php echo $company_id; ?>" class="large-field" hidden="hidden" />
	...
	<input type="text" name="tax_id" value="<?php echo $tax_id; ?>" class="large-field" hidden="hidden" />
	<tr>
	  <td valign="top">Alamat <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="address_1" value="<?php echo $address_1; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<!--<tr>
	...
	<tr>
	  ...
	  <td valign="top"><input type="text" name="city" value="<?php echo $city; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Kode Pos <span id="postcode-required" class="required">*</span></td>
	  <td valign="top"><input type="text" name="postcode" value="<?php echo $postcode; ?>" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<!--<tr>
...
<div class="buttons" style="margin-top:10px;border:none;">
  <div class="right">
    <input type="button" value="" id="button-guest" class="ss-continue-button" />
  </div>
</div>
