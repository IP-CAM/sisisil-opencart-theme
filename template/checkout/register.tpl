...
<div>
  <table class="form">
	<tr>
		...
		<td valign="top"><input type="text" name="firstname" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Nama Belakang <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="lastname" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Email <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="email" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Telepon <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="telephone" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top"><?php echo $entry_fax; ?></td>
	  <td valign="top"><input type="text" name="fax" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
  </table>
</div>
...
<div>
  <table class="form">
	...
	<input type="text" name="company" value="" class="large-field" hidden="hidden" /> 
	...
	<input type="text" name="company_id" value="" class="large-field" hidden="hidden" />
	...
	<input type="text" name="tax_id" value="" class="large-field" hidden="hidden" />
	<tr>
	  <td valign="top">Alamat <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="address_1" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<!--<tr>
	  <td><?php echo $entry_address_2; ?></td>
	  <td><input type="text" name="address_2" value="<?php echo $address_2; ?>" /></td>
	</tr>-->
	<input type="text" name="address_2" value="" class="large-field" hidden="hidden" />
	<tr>
	  <td valign="top">Kota <span class="required">*</span></td>
	  <td valign="top"><input type="text" name="city" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Kode Pos <span id="postcode-required" class="required">*</span></td>
	  <td valign="top"><input type="text" name="postcode" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<!--<tr>
	...
	<tr>
	  ...
	  <td valign="top"><select name="zone_id" class="large-field"></select><br /></td>
	</tr>
  </table>
</div>
...
<div>
  <table class="form">
	<tr>
	  ...
	  <td valign="top"><input type="password" name="password" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
	<tr>
	  <td valign="top">Konfirmasi Kata Sandi <span class="required">*</span></td>
	  <td valign="top"><input type="password" name="confirm" value="" class="large-field" style="width:350px;" /><br /></td>
	</tr>
  </table>
</div>
...
<div>
  <h2>Data Anda</h2>
  &nbsp;Nama Depan <span class="required">*</span>&nbsp;&nbsp;<input type="text" name="firstname" value="" class="large-field" />
  <br />
  <br />
  &nbsp;Nama Belakang <span class="required">*</span>&nbsp;&nbsp;<input type="text" name="lastname" value="" class="large-field" />
  <br />
  <br />
  ...
  <br />
  <br />
  &nbsp; Telepon <span class="required">*</span><br />
...
-->
<div style="clear: both; height:10px;padding-top: 5px;padding-bottom: 10px; border-top: 1px solid #ccc;border-bottom: 1px solid #ccc;">
  <input type="checkbox" name="newsletter" value="1" id="newsletter" hidden="hidden"/>
  <!--<label for="newsletter"><?php echo $entry_newsletter; ?></label>-->
  <?php if ($shipping_required) { ?>
  <input type="checkbox" name="shipping_address" value="1" id="shipping" checked="checked" />
  <label for="shipping">Alamat pengiriman dan alamat penagihan saya adalah sama.</label>
  <br />
  <?php } ?>
  <br />
  <br />
...
<?php if ($text_agree) { ?>
<div class="buttons" style="margin-top:10px;border:none;">
  <div class="right">
    <input type="checkbox" name="agree" value="1" checked="checked" hidden="hidden"/>
    <input type="button" value="" id="button-register" class="ss-continue-button" />
  </div>
</div>
<?php } else { ?>
<div class="buttons" style="margin-top:10px;border:none;">
  <div class="right">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" class="ss-continue-button" />
  </div>
</div>
<?php } ?>
